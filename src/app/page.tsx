      ...
      <section className="flex-1 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 w-full">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            Masuk dengan akun yang diberikan sekolahmu untuk mulai belajar.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-24 pt-16 border-t border-border">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-muted-foreground text-sm">
              Puzzle visual yang membuat belajar jadi fun dan mudah diingat.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="flex flex-col items-center text-center md:items-start md:text-left">
              ...
              <p className="text-sm text-muted-foreground">
                Pilih modul di peta dunia dan mulai kerjakan puzzle-nya.
              </p>
            </div>
      ...
      <section className="border-t border-border">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Buat akun untuk progress belajar yang berkelanjutan.
          </p>

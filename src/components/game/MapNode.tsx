...
export function MapNode({ node, isSelected, isCurrent, onClick }: MapNodeProps) {
  ...
  return (
    ...
    >
      ...
      >
        <Icon className={cn('h-7 w-7 sm:h-9 sm:w-9', isLocked ? 'text-muted-foreground' : 'text-white')} />
      </div>
